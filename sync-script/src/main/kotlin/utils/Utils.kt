...
/**
 * If [ScriptConfig.isGuiEnabledOverride] is true, will use [GuiUtils.showErrorMessage]
 ...
 *
 *
 * Whatever if it should use GUI to show error or not, will use [ScriptConfig.isGuiEnabledOverride],
